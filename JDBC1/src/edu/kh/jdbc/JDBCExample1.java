...
public class JDBCExample1 {
	...
	public static void main(String[] args) {
		...
		/* 
		 * JDBC(Java DataBase Connectivity_
		 * 
		...
		/* 2. DriveManager 객체를 이용해서 Connection 객체 생성하기 */
		...
		String userName = "kh_kyu"; // 사용자 계정명
		...
		while( rs.next()) {
			// 200 선동일 09 J1 8000000 1990-02-06 00:00:00.000
			
			// rs.get 자료형 ( 컬럼명 | 순서 ) ;
			// - 현재 행에서 지정된 컬럼의 값을 얻어와 반환
			// -> 지정된 자료형 형태로 값이 반환됨
			// (자료형을 잘못 지정하면 예외가 발생함) 
			...
			// SOLExcept : DB연결과 관련된 모든 예외의 최상의 부모
			e.printStackTrace();
