...
public class JDBCTemplate {
	...
	public static Connection getConnection() {
		...
		try {
			 ...
			 * 
			 *  이유 1: 보안상의 이유(Github에 DB연결 정보 등 올리면 해킹하라는 뜻... 올리면안댐)
			...
			// prop에 저장된 값(dirver.xml에서 읽어온 값)을 이용해서
			// Connection 객체 생성
			
			// prop.getPropertry("key") : key가 일치하는 value를 반환
	...
	/** 전달 받은 Statement + PreparedStatment 둘 다 close()
	 * + 다형성 업캐스팅 적용
